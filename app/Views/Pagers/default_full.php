...
<nav aria-label="<?= lang('Pager.pageNavigation') ?>">
	<ul class="pagination pt-5 justify-content-center">
		<?php if ($pager->hasPrevious()) : ?>
			...
			<li class="page-item">
				<a class="page-link text-dark" href="<?= $pager->getPrevious() ?>" aria-label="<?= lang('Pager.previous') ?>">
		...
		<?php foreach ($pager->links() as $link) : ?>
			<li class="page-item" <?= $link['active'] ? 'class="active"' : '' ?>>
				<a class="page-link text-dark" href="<?= $link['uri'] ?>">
					<?= $link['title'] ?>
				</a>
			</li>
		<?php endforeach ?>
		...
		<?php if ($pager->hasNext()) : ?>
			<li class="page-item">
				<a class="page-link text-dark" href="<?= $pager->getNext() ?>" aria-label="<?= lang('Pager.next') ?>">
